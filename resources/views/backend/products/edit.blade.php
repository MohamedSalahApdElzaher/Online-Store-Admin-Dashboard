                                    ...
                                    <div class="col-12">
                                                    ...
                                                    <div class="controls">
                                                        <select name="subcategory_id" class="form-control" required="">
                                                            ...
                                                            @foreach ($sub_categories as $category)
                                                                <option value="{{ $category->id }}"
                                                                    {{ $category->id == $product->subcategory_id ? 'selected' : '' }}>
                                                    ...
                                                    <div class="controls">
                                                        <select name="subsubcategory_id" class="form-control" required="">
                                                            ...
                                                            @foreach ($sub_subcategories as $category)
                                                                <option value="{{ $category->id }}"
                                                                    {{ $category->id == $product->subsubcategory_id ? 'selected' : '' }}>
                                                                    {{ $category->sub_subcategorie_name_en }}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_name_en" class="form-control"
                                                            required="" value="{{ $product->product_name_en }}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_name_ar" class="form-control"
                                                            required="" value="{{ $product->product_name_ar }}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_tags_en" class="form-control"
                                                            value="{{ $product->tags_en }}" data-role="tagsinput"
                                                            required="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_tags_ar" class="form-control"
                                                            value="{{ $product->tags_ar }}" data-role="tagsinput"
                                                            required="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_size_en" class="form-control"
                                                            value="{{ $product->size_en }}" data-role="tagsinput"
                                                            required="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_size_ar" class="form-control"
                                                            value="{{ $product->size_ar }}" data-role="tagsinput"
                                                            required="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_color_en" class="form-control"
                                                            value="{{ $product->color_en }}" data-role="tagsinput"
                                                            required="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_color_ar" class="form-control"
                                                            value="{{ $product->color_ar }}" data-role="tagsinput"
                                                            required="">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <img src="{{ asset($product->thambnail) }}" id="mainThmb"
                                                style="width:70px;height:70px;margin-top:10px">

                                                <input type="hidden" name="old_img" value="{{ $product->thambnail }}">
                            ...
                            <div class="row row-sm">
                                @foreach ($multiImgs as $img)
                                    <div class="col-md-3">
                                        ...
                                        <div class="card">
                                            <img src="{{ asset($img->img_name) }}" class="card-img-top"
                                                style="height: 130px; width: 280px;">
                                            <div class="card-body">
                                                <h5 class="card-title">
                                                    <a href="{{ url('product/image/delete/'.$img->id) }}"
